    ...
    <Link to={strUrl} >
        ...
        <div className="card" onClick={() => {viewCocktailDetail(cocktail.idDrink)}}>
            ...
            <svg className="card__svg" viewBox="0 0 800 500">
                ...
                <path className="card__line" d="M 0 370 Q 50 370 100 370 Q 250 370 350 370 C 400 370 550 370 650 370 Q 675 370 700 370 Q 790 370 800 500" stroke="pink" strokeWidth="12" fill="transparent"/>
                <path className="card__line_2" d="M 0 360 Q 50 360 100 360 Q 250 360 350 360 C 400 360 550 360 650 360 Q 675 360 700 360 Q 790 360 800 490" stroke="pink" strokeWidth="12" fill="transparent"/>
                <path className="card__line_3" d="M 0 350 Q 50 350 100 350 Q 250 350 350 350 C 400 350 550 350 650 350 Q 675 350 700 350 Q 790 350 800 490" stroke="pink" strokeWidth="12" fill="transparent"/>
            </svg>
